    ...
    public class HomeController : BaseController
    {
        ...
        public ActionResult Index(){
            using (club = new ClubEntities()) {
                ...
                ViewBag.topics = club.ViewTopicIndexes.OrderByDescending(t=>t.VarDate).Take(ClubConst.WebPageSize).Where(t => t.Area == 0).ToList<ViewTopicIndex>();
                ViewBag.hotActivity = club.ViewActivities.OrderByDescending(a => a.VarDate).Take(5).ToList<ViewActivity>();
                ...
                ViewBag.tags = club.Tags.OrderByDescending(t=>t.Vardate).Where(t=>t.Tops>=0).Take(10).ToList<Tag>();
            }
            return View();
        }
    }
